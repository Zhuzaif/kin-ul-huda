...
export default function NisaHeader() {
  return (
    <div className="px-6 pt-3 pb-2">
      <div className="relative overflow-hidden rounded-[32px] bg-gradient-to-br from-soft-pink via-[#FCE7D8] to-light-peach p-6 shadow-[0_4px_24px_rgba(217,138,91,0.12)] border border-theme-border">
        <div className="absolute -right-8 -top-8 w-36 h-36 bg-theme-surface-card rounded-full blur-2xl pointer-events-none" />
        ...
        <div className="relative z-10 flex items-start justify-between gap-4">
          ...
          <div className="relative flex-shrink-0">
            ...
            <div className="relative w-14 h-14 rounded-full bg-theme-surface-card backdrop-blur-sm border-2 border-white shadow-[0_4px_16px_rgba(235,182,186,0.35)] flex items-center justify-center">
