...
export default function PeriodModeBanner({ message = defaultMessage }: PeriodModeBannerProps) {
  ...
  return (
    <div className="px-6 mt-2">
      <div className="bg-soft-pink/60 border border-white/70 rounded-[18px] px-4 py-3 shadow-[0_6px_14px_rgba(0,0,0,0.04)] flex items-start gap-3">
        ...
        <button
          ...
          className="w-7 h-7 rounded-full bg-white/60 flex items-center justify-center text-gray-500 hover:bg-white transition-colors"
